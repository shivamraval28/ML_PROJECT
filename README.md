...
The project is an application based on the work that has been done on Mask R-CNN where the model source code was pre-trained on FPN and ResNet101 and also has the pre-trained weights for MS COCO adn the training code for MS COCO. The below URL provides the location of the algorithm.
